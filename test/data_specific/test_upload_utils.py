...
class TestLoader(TestCase):
    ...
    def test_load_entities_with_filter(self):
        self.loader.__resolve_entities("{{resolve /shape/ethics/authority/v0.0.1/?filter={\"filter\": {\"path\": \"http://schema.org/identifier\", \"value\": \"d5b9290a0b67727d4ba1ca6059dc31a6\", \"op\": \"eq\"}}}}")
