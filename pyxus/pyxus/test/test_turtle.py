...
def ignore_id(value_to_ignore, deepdiff_dict):
...
class TestSchemaRepository(TestCase):
    ...
    expected_jsonld_schema = {'shapes': [
        {u'http://www.w3.org/ns/shacl#maxCount': [{u'@value': 1}], u'@id': u'_:ub1bL0C255', u'http://www.w3.org/ns/shacl#path': [{u'@id': u'http://xmlns.com/foaf/0.1/name'}],
         u'http://www.w3.org/ns/shacl#minCount': [{u'@value': 1}], u'http://www.w3.org/ns/shacl#datatype': [{u'@id': u'http://www.w3.org/2001/XMLSchema#string'}]},
        {u'http://www.w3.org/ns/shacl#property': [{u'@id': u'_:ub1bL0C255'}], u'http://www.w3.org/ns/shacl#targetClass': [{u'@id': u'http://xmlns.com/foaf/0.1/Person'}],
         u'@id': u'http://foaf_sh.com/PersonShape', u'@type': [u'http://www.w3.org/ns/shacl#NodeShape']}],
                              u'@context': {u'shapes': {u'@reverse': u'rdfs:isDefinedBy', u'@type': u'@id'}, u'owl': u'http://www.w3.org/2002/07/owl#',
                                            u'isDefinedBy': {u'@id': u'rdfs:isDefinedBy', u'@type': u'@id'}, u'rdfs': u'http://www.w3.org/2000/01/rdf-schema#'}, u'@type': u'owl:Ontology'}
    ...
    def test_create_turtle_schema(self):
        ...
        if res['values_changed']:
            assert all(ignore_id(self.json_schema_id, value) for key, value in res['values_changed'].iteritems())
        assert True
